...
const ENV_SCHEMA = [
    ...
    'RESEND_WEBHOOK_SECRET' => ['required' => false, 'type' => 'string'],
    'APP_SECRET' => ['required' => false, 'type' => 'string'],
    'VAPID_PUBLIC_KEY' => ['required' => false, 'type' => 'string'],
    'VAPID_PRIVATE_KEY' => ['required' => false, 'type' => 'string'],
    ...
    'VIATOR_API_KEY' => ['required' => false, 'type' => 'string'],
    'VIATOR_API_BASE_URL' => ['required' => false, 'type' => 'url'],
    'VIATOR_API_ENABLED' => ['required' => false, 'type' => 'bool'],
    'VIATOR_SYNC_TTL_HOURS' => ['required' => false, 'type' => 'string'],
