...
<div class="overflow-x-auto my-8">
    <table class="comparison-table w-full">
        ...
        <tbody>
            <tr><td><strong>Beach Quality</strong></td><td>Exceptional, world-famous</td><td>Excellent, more variety</td></tr>
            <tr><td><strong>Crowds</strong></td><td>Moderate at Flamenco, empty elsewhere</td><td>Very low everywhere</td></tr>
            <tr><td><strong>Accessibility</strong></td><td>Most beaches easy to reach</td><td>Many require 4WD or hiking</td></tr>
            <tr><td><strong>Snorkeling</strong></td><td>Excellent, easy shore access</td><td>Excellent, often requires boat</td></tr>
            <tr><td><strong>Accommodation</strong></td><td>Limited, basic options</td><td>More variety, better range</td></tr>
            <tr><td><strong>Dining</strong></td><td>~15 restaurants, casual</td><td>~30+ restaurants, more variety</td></tr>
            <tr><td><strong>Nightlife</strong></td><td>Minimal, very quiet</td><td>Low-key bars, live music</td></tr>
            <tr><td><strong>Transportation</strong></td><td>Golf carts, scooters, Jeeps</td><td>Cars, Jeeps essential</td></tr>
            <tr><td><strong>Daily Budget</strong></td><td>$150-250/day</td><td>$120-220/day</td></tr>
            <tr><td><strong>Ideal Stay</strong></td><td>2-3 days</td><td>3-5 days</td></tr>
        </tbody>
    </table>
</div>',

    'beaches_culebra_desc' => '
<p class="mb-4"><strong>Flamenco Beach</strong> is Culebra\'s flagship—a mile-long crescent of powder-white sand and turquoise water consistently ranked among the world\'s best beaches. It has facilities, lifeguards, food vendors, and calm waters perfect for swimming. Arrive before 10 AM on weekends for parking.</p>
<p class="mb-4"><strong>Tamarindo Beach</strong> offers excellent snorkeling with sea turtles often visible. It\'s a short hike from the parking area, keeping crowds minimal. The reef is close to shore, ideal for beginners.</p>
<p class="mb-4"><strong>Zoni Beach</strong> on the northeast coast is wild and windswept with dramatic views. Less crowded than Flamenco but rougher waters. Excellent for long walks and solitude.</p>',

    'beaches_vieques_desc' => '
<p class="mb-4"><strong>Sun Bay</strong> is the main public beach with facilities, camping, and lifeguards on weekends. Wide sandy beach with calm waters good for families. Entrance fee $5.</p>
<p class="mb-4"><strong>Media Luna</strong> (Half Moon Bay) lives up to its name with a perfect crescent shape. Calm, shallow water ideal for snorkeling. Requires driving rough dirt road—4WD recommended.</p>
<p class="mb-4"><strong>Playa Negra (Black Sand Beach)</strong> is unique with volcanic black sand. Dramatic coastline, good for exploring but not swimming due to rough surf.</p>',
...
<p class="mb-4">Both islands are served by ferries from Ceiba on the mainland. <strong>Passenger tickets cost $2-4 each way</strong>, making ferries the budget option. However, booking is challenging—reserve 2-3 weeks ahead through the maritime authority website. Ferries run multiple times daily, taking 60-70 minutes.</p>
...
<p class="mb-4">Small aircraft fly from San Juan (SJU) or Ceiba to both islands in 25-30 minutes. <strong>Round-trip costs $100-200</strong> per person. Airlines include Cape Air, Vieques Air Link, and Air Flamenco. Strict 40-pound baggage limits—pack light.</p>
<h3 class="text-2xl font-bold text-gray-900 mt-8 mb-4">Island Transportation</h3>
<p class="mb-4"><strong>Culebra:</strong> Golf carts ($60-80/day) are popular and sufficient for paved roads. Scooters ($50/day) and Jeeps ($75-100/day) also available. The island is small—everywhere is 15 minutes or less.</p>
<p class="mb-4"><strong>Vieques:</strong> Rent a Jeep or 4WD vehicle ($70-120/day). Many beaches require unpaved roads where golf carts struggle. The island is 5x larger than Culebra—expect 20-30 minute drives to remote beaches.</p>',
...
<p class="mb-4"><strong>Limited options</strong> concentrated in Dewey, the main town. Expect basic guesthouses, small inns, and vacation rentals. Few amenities—this is rustic island living. Book months ahead for peak season.</p>
...
<p class="mb-4"><strong>More variety and availability</strong> across two towns—Isabel II (north) and Esperanza (south). Better restaurant access in both areas. More developed tourism infrastructure.</p>
<ul class="list-disc list-inside space-y-2 text-gray-700 mb-6">
...
<p class="mb-4"><strong>Both islands are expensive</strong> due to remoteness and limited supply. Everything is imported, inflating prices 20-40% above mainland Puerto Rico.</p>
