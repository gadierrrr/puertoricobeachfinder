<?php
/**
 * Surfing Guide — English body content sections.
...
<h3 class="text-2xl font-bold text-gray-900 mt-8 mb-4">Northwest Coast (Rincon, Aguada, Aguadilla)</h3>
<p class="mb-4"><strong>The surf capital.</strong> Rincon is Puerto Rico\'s most famous surf town with world-class breaks. Winter swells produce powerful waves 6-15+ feet. Reef breaks dominate, requiring experience. Surf culture thrives with shops, schools, and competitions.</p>
<h3 class="text-2xl font-bold text-gray-900 mt-8 mb-4">North Coast (Isabela, Arecibo, Hatillo)</h3>
<p class="mb-4"><strong>Consistent and accessible.</strong> Isabela offers excellent reef breaks like Jobos and Middles. Less crowded than Rincon but equally powerful winter waves. Good infrastructure with rentals and accommodations.</p>
