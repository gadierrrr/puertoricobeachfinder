<?php
/**
 * Beach Packing List — English body content sections.
 * Returns an associative array of HTML fragments keyed by section name.
 */
return [
    'intro' => '<p class="lead text-xl text-gray-700 mb-8">Packing efficiently for Puerto Rico beaches ensures you have everything needed for comfort, safety, and fun without overpacking. This comprehensive checklist covers absolute essentials, recommended items, and optional extras based on your planned activities. Whether you\'re visiting calm Caribbean beaches or adventurous north coast surf breaks, this guide has you covered.</p>',

    'essentials' => '
<h2 id="essentials" class="text-3xl font-bold text-gray-900 mt-12 mb-6">Absolute Essentials</h2>
<p class="mb-4"><strong>These items are non-negotiable</strong> for any beach day in Puerto Rico. The Caribbean sun is intense year-round, and being unprepared can ruin your vacation with painful sunburn, dehydration, or lost valuables.</p>
...
<p class="mb-4">Beyond your swimsuit, several items enhance safety, comfort, and enjoyment in the water. <strong>Quality makes a difference</strong>—ill-fitting snorkel masks or leaky waterproof cases can ruin experiences.</p>
...
<p class="mb-4"><strong>These items transform a basic beach visit into a comfortable, all-day experience</strong>. While not strictly necessary, they significantly improve enjoyment, especially for families or extended beach sessions.</p>
<div class="bg-gray-50 rounded-lg p-6 my-6">
...
<p class="mb-4"><strong>A compact first aid kit handles most minor beach injuries</strong>—cuts from shells, scrapes from rocks, jellyfish stings, or splinters. Packing these items prevents minor issues from derailing your day.</p>
...
<p class="mb-4"><strong>Sand, salt water, and sun are enemy to electronics</strong>, yet most travelers want to capture memories and stay connected. Proper protection prevents expensive damage while allowing you to document your beach adventures.</p>
<div class="space-y-3 mb-6">
...
<p class="mb-4"><strong>Customize your packing list</strong> based on planned activities, interests, and travel style. These items aren\'t necessary for everyone but enhance specific beach experiences.</p>
...
<p class="mb-4"><strong>How you pack matters as much as what you pack</strong>. These strategies keep gear organized, accessible, and protected during beach days.</p>
