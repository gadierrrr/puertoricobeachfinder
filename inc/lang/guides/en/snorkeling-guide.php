<?php
/**
 * Snorkeling Guide — English body content sections.
...
<li><strong>Year-round warm water</strong> (78-85&deg;F) requires no wetsuit</li>
...
<li><strong>Easy shore access</strong> at many beaches&mdash;no boat needed</li>
...
<p class="mb-4"><strong>Proper fit is critical.</strong> Test mask by pressing to face without using strap&mdash;it should stay on by suction. Common mistakes: choosing based on color rather than fit, buying masks that leak, or using old masks with deteriorated silicone.</p>
<h3 class="text-2xl font-bold text-gray-900 mt-8 mb-4">Snorkel Tube</h3>
<p class="mb-4"><strong>Simple is better.</strong> Avoid complex designs with multiple valves that can fail. A basic J-shaped tube with a comfortable mouthpiece works best. Purge valves at the bottom help clear water.</p>
<h3 class="text-2xl font-bold text-gray-900 mt-8 mb-4">Fins</h3>
<p class="mb-4"><strong>Full-foot vs adjustable.</strong> Full-foot fins are lighter and better for warm water snorkeling. Adjustable fins work with booties for rocky entries. Longer fins provide more power but require stronger legs.</p>
...
<li>&bull; Parrotfish (rainbow colors, &ldquo;beak&rdquo; mouth)</li>
<li>&bull; Blue Tang (bright blue, &ldquo;Dory&rdquo; fish)</li>
<li>&bull; French Angelfish (black/yellow stripes)</li>
<li>&bull; Sergeant Major (black vertical stripes)</li>
<li>&bull; Stoplight Parrotfish (males: green/pink/blue)</li>
</ul>
</div>
<div class="bg-slate-50 rounded-lg p-6">
<h3 class="text-xl font-bold text-gray-900 mb-3">Special Encounters</h3>
<ul class="space-y-1 text-gray-700">
<li>&bull; Green Sea Turtles (common, surface to breathe)</li>
<li>&bull; Southern Stingrays (often buried in sand)</li>
<li>&bull; Octopus (masters of camouflage)</li>
<li>&bull; Eagle Rays (occasional, graceful swimmers)</li>
<li>&bull; Nurse Sharks (harmless, rest under ledges)</li>
</ul>
</div>
</div>',
