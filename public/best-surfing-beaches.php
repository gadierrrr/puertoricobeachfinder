...
<section class="collection-content-nav bg-white border border-warm-200">
    <div class="max-w-7xl mx-auto px-4 py-4">
        <div class="flex flex-wrap gap-2 justify-center text-sm">
            <span class="text-warm-500"><?= h(__('pages.best_surfing_beaches.jump_to')) ?></span>
            <a href="#top-beaches" class="text-ocean-500 hover:underline"><?= h(__('pages.best_surfing_beaches.jump_top_spots')) ?></a>
            <span class="text-warm-300">|</span>
            <a href="#by-level" class="text-ocean-500 hover:underline"><?= h(__('pages.best_surfing_beaches.jump_by_level')) ?></a>
            <span class="text-warm-300">|</span>
            <a href="#season" class="text-ocean-500 hover:underline"><?= h(__('pages.best_surfing_beaches.jump_season')) ?></a>
            <span class="text-warm-300">|</span>
            <a href="#faq" class="text-ocean-500 hover:underline"><?= h(__('pages.best_surfing_beaches.jump_faq')) ?></a>
        </div>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-3 gap-6">
            <div class="bg-white border border-warm-200 rounded-xl p-6 shadow-card">
                ...
                <h3 class="text-lg font-bold text-warm-900 mb-3"><?= h(__('pages.best_surfing_beaches.level_beginner_title')) ?></h3>
                <ul class="text-warm-500 text-sm space-y-2">
            ...
            <div class="bg-white border border-warm-200 rounded-xl p-6 shadow-card">
                <div class="text-3xl mb-4">🌊</div>
                <h3 class="text-lg font-bold text-warm-900 mb-3"><?= h(__('pages.best_surfing_beaches.level_intermediate_title')) ?></h3>
                <ul class="text-warm-500 text-sm space-y-2">
            ...
            <div class="bg-white border border-warm-200 rounded-xl p-6 shadow-card">
                <div class="text-3xl mb-4">🔥</div>
                <h3 class="text-lg font-bold text-warm-900 mb-3"><?= h(__('pages.best_surfing_beaches.level_advanced_title')) ?></h3>
                <ul class="text-warm-500 text-sm space-y-2">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-2 gap-8">
            <div class="bg-slate-50 rounded-xl p-6">
                <h3 class="text-xl font-bold text-warm-900 mb-4"><?= h(__('pages.best_surfing_beaches.season_winter_title')) ?></h3>
                <ul class="text-warm-700 space-y-2">
            ...
            <div class="bg-slate-50 rounded-xl p-6">
                <h3 class="text-xl font-bold text-warm-900 mb-4"><?= h(__('pages.best_surfing_beaches.season_summer_title')) ?></h3>
                <ul class="text-warm-700 space-y-2">
...
<section class="py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center">
            ...
            <p class="text-warm-500 mt-4"><?= h(__('pages.best_surfing_beaches.map_desc')) ?></p>
        </div>
    </div>
</section>
