...
<section class="collection-content-nav bg-white border border-warm-200">
    <div class="max-w-7xl mx-auto px-4 py-4">
        <div class="flex flex-wrap gap-2 justify-center text-sm">
            <span class="text-warm-500"><?= h(__('pages.best_snorkeling_beaches.jump_to')) ?></span>
            <a href="#top-beaches" class="text-ocean-500 hover:underline"><?= h(__('pages.best_snorkeling_beaches.jump_top_spots')) ?></a>
            <span class="text-warm-300">|</span>
            <a href="#tips" class="text-ocean-500 hover:underline"><?= h(__('pages.best_snorkeling_beaches.jump_tips')) ?></a>
            <span class="text-warm-300">|</span>
            <a href="#faq" class="text-ocean-500 hover:underline"><?= h(__('pages.best_snorkeling_beaches.jump_faq')) ?></a>
            <span class="text-warm-300">|</span>
            <a href="#map" class="text-ocean-500 hover:underline"><?= h(__('pages.best_snorkeling_beaches.jump_map')) ?></a>
        </div>
    </div>
</section>
...
<section class="py-12">
    <div class="max-w-4xl mx-auto px-4">
        <div class="prose prose-lg max-w-none prose-brand">
            ...
            <p><?= __('pages.best_snorkeling_beaches.intro_p3') ?></p>
        </div>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div class="bg-white border border-warm-200 rounded-xl p-6 shadow-card">
                ...
                <h3 class="text-lg font-bold text-warm-900 mb-2"><?= h(__('pages.best_snorkeling_beaches.tip_1_title')) ?></h3>
                <p class="text-warm-500 text-sm"><?= h(__('pages.best_snorkeling_beaches.tip_1_desc')) ?></p>
            </div>

            <div class="bg-white border border-warm-200 rounded-xl p-6 shadow-card">
                <div class="text-3xl mb-4">🧴</div>
                <h3 class="text-lg font-bold text-warm-900 mb-2"><?= h(__('pages.best_snorkeling_beaches.tip_2_title')) ?></h3>
                <p class="text-warm-500 text-sm"><?= h(__('pages.best_snorkeling_beaches.tip_2_desc')) ?></p>
            </div>

            <div class="bg-white border border-warm-200 rounded-xl p-6 shadow-card">
                <div class="text-3xl mb-4">🐢</div>
                <h3 class="text-lg font-bold text-warm-900 mb-2"><?= h(__('pages.best_snorkeling_beaches.tip_3_title')) ?></h3>
                <p class="text-warm-500 text-sm"><?= h(__('pages.best_snorkeling_beaches.tip_3_desc')) ?></p>
            </div>

            <div class="bg-white border border-warm-200 rounded-xl p-6 shadow-card">
                <div class="text-3xl mb-4">👥</div>
                <h3 class="text-lg font-bold text-warm-900 mb-2"><?= h(__('pages.best_snorkeling_beaches.tip_4_title')) ?></h3>
                <p class="text-warm-500 text-sm"><?= h(__('pages.best_snorkeling_beaches.tip_4_desc')) ?></p>
            </div>

            <div class="bg-white border border-warm-200 rounded-xl p-6 shadow-card">
                <div class="text-3xl mb-4">🌊</div>
                <h3 class="text-lg font-bold text-warm-900 mb-2"><?= h(__('pages.best_snorkeling_beaches.tip_5_title')) ?></h3>
                <p class="text-warm-500 text-sm"><?= h(__('pages.best_snorkeling_beaches.tip_5_desc')) ?></p>
            </div>

            <div class="bg-white border border-warm-200 rounded-xl p-6 shadow-card">
                <div class="text-3xl mb-4">📍</div>
                <h3 class="text-lg font-bold text-warm-900 mb-2"><?= h(__('pages.best_snorkeling_beaches.tip_6_title')) ?></h3>
                <p class="text-warm-500 text-sm"><?= h(__('pages.best_snorkeling_beaches.tip_6_desc')) ?></p>
            </div>
        </div>
    </div>
</section>
...
<section id="map" class="py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center">
            ...
            <p class="text-warm-500 mt-4"><?= h(__('pages.best_snorkeling_beaches.map_desc')) ?></p>
        </div>
    </div>
</section>
