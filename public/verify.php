...
if (!$token) {
    ...
    echo '<div class="max-w-md mx-auto px-4 py-16 text-center">
            ...
            <a href="/login" class="inline-block bg-sunset-400 hover:bg-sunset-300 text-ocean-900 px-6 py-3 rounded-lg font-medium">
                Request New Link
            </a>
          </div>';
    include APP_ROOT . '/components/footer-minimal.php';
    exit;
}
