...
$extraHead .= howToSchema(
    ...
    [
        ['name' => 'Scout Location', 'text' => 'Visit beach before golden hour to find best compositions, interesting foreground elements, and vantage points.'],
        ['name' => 'Use Golden Hour Light', 'text' => 'Shoot during first hour after sunrise or last hour before sunset for warm, flattering light.'],
        ['name' => 'Add Foreground Interest', 'text' => 'Include rocks, palm trees, shells, or people in foreground to create depth and context.'],
        ['name' => 'Use Polarizing Filter', 'text' => 'Reduce glare from water and wet sand, enhance blue skies and water clarity.'],
        ['name' => 'Experiment with Angles', 'text' => 'Shoot from low angles for drama, high vantage points for context, eye-level for intimacy.'],
        ['name' => 'Protect Equipment', 'text' => 'Keep camera in sealed bag between shots, use UV filter, clean regularly with proper tools.']
    ]
);
