...
<?php
$extraHead = $extraHead ?? "";
$extraHead .= articleSchema($pageTitle, $pageDescription, '/guides/best-time-visit-puerto-rico-beaches', null, '2024-01-15');
    $extraHead .= faqSchema($faqs);
    $extraHead .= breadcrumbSchema([
        ['name' => 'Home', 'url' => '/'],
        ['name' => 'Guides', 'url' => '/guides/'],
        ['name' => 'Best Time to Visit', 'url' => '/guides/best-time-visit-puerto-rico-beaches']
    ]);
$pageTheme = "guide";
$skipMapCSS = true;
$skipMapScripts = true;
