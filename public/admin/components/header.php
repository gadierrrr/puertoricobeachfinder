    ...
    <div class="flex min-h-screen">
        ...
        <aside class="admin-sidebar bg-gray-900 text-white flex flex-col">
            ...
            <nav class="flex-1 p-4 space-y-1">
                ...
                <a href="/admin/homepage-design"
                   class="flex items-center gap-3 px-3 py-2 rounded-lg <?= $currentPage === 'homepage-design' ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-800' ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
