...
<section class="hero-gradient text-white py-16 md:py-20">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-lg md:text-xl opacity-90 max-w-3xl mx-auto page-description">
            From world-famous Flamenco Beach to hidden Caribbean gems, discover Puerto Rico's most stunning coastlines. Our expert guide covers the top beaches for swimming, snorkeling, surfing, and relaxation.
        </p>
        <p class="text-sm mt-4 opacity-75">Updated January 2025 | Based on 233+ beaches analyzed</p>
    </div>
</section>
