...
<head>
    ...
    <style>
        ...
        .comparison-table td, .comparison-table th { padding: 1rem; border: 1px solid #e5e7eb; }
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
            <aside class="lg:col-span-1">
                <div class="toc-sticky bg-white rounded-lg shadow-card p-6">
                    ...
                    <nav class="space-y-2">
                        <a href="#overview" class="block text-green-600 hover:text-green-700 text-sm">Quick Overview</a>
                        <a href="#comparison" class="block text-green-600 hover:text-green-700 text-sm">Side-by-Side</a>
                        <a href="#beaches" class="block text-green-600 hover:text-green-700 text-sm">Beaches</a>
                        <a href="#transportation" class="block text-green-600 hover:text-green-700 text-sm">Getting There</a>
                        <a href="#accommodation" class="block text-green-600 hover:text-green-700 text-sm">Where to Stay</a>
                        <a href="#activities" class="block text-green-600 hover:text-green-700 text-sm">Activities</a>
                        <a href="#verdict" class="block text-green-600 hover:text-green-700 text-sm">Final Verdict</a>
