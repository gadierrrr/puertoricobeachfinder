...
<head>
    ...
    <link rel="preload" href="/assets/css/styles.css?v=5.2" as="style">
    ...
    <link rel="stylesheet" href="/assets/css/tailwind.min.css?v=4.1">
    ...
    <!-- Custom styles -->
    <link rel="stylesheet" href="/assets/css/styles.css?v=5.2">
