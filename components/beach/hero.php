...
<div class="relative h-[50vh] max-h-[450px] overflow-hidden">
    ...
    <div class="absolute bottom-0 left-0 right-0 p-4 md:p-6 lg:p-8">
        <div class="max-w-7xl mx-auto">
            <!-- Breadcrumbs -->
            <nav class="text-white/70 text-xs sm:text-sm mb-2" aria-label="Breadcrumb">
            ...
            <h1 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white uppercase tracking-tight leading-none">
                <?= h($beach['name']) ?>
                <span class="block text-base sm:text-lg md:text-xl lg:text-2xl mt-1 text-sunset-400 font-serif normal-case italic">
