<?php
/**
 * Navigation-Only Header Component
 * For pages that define their own HTML/head/body structure (e.g., guide pages)
 * Outputs ONLY the navigation bar and skip links
 */
