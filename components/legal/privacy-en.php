<section class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="prose prose-slate max-w-none">
        ...
        <ul>
            ...
            <li><strong>Advertising inquiry data</strong>: business and contact details, requested placement, and the message you submit when asking about advertising.</li>
            <li><strong>Paid-placement measurement</strong>: viewable impressions, clicks, placement context, and short-lived pseudonymous network/device hashes used to prevent duplicate or fraudulent counts.</li>
        </ul>
        ...
        <ul>
            ...
            <li>To respond to advertising inquiries, prepare and operate approved campaigns, report aggregate delivery, and prevent measurement abuse.</li>
        </ul>
        ...
        <p>
            Paid placements are contextual to the beach, guide, collection, municipality, or region being viewed. We do not
            provide advertisers with visitor identities, raw IP addresses, or individual browsing histories, and we do not
            install advertiser tracking pixels as part of this program.
        </p>
        ...
        <p>
            ...
            Advertising inquiry records are generally retained for up to 24 months after the last activity. Raw paid-placement
            events are generally retained for 90 days and aggregate campaign metrics for up to 25 months. Contract, invoice,
            and accounting records may be retained longer where legally required.
        </p>
